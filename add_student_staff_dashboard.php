...
<form action="add_student_staff_dashboard_data.php" method="post" enctype="multipart/form-data">
            ...
            <div class="card">
              <div class="card-body" style="background: seashell; border:3px solid black;">
					...
					<div class="col-sm-5 col-md-5 col-lg-5 col-xl-5">
					  ...
					  <div class="form-row">
	                <div class="col-6">
					<button name="add_stu" type="submit" class="btn btn-primary btn-lg btn-block login-btn"><h2>ADD Student</h2></button>
					</div>
	                <div class="col-6">
