...
<tr style="text-align: center; margin-left:100px; background-color:skyblue;"><td><b>S.No.</b></td><td><b>Student Name</b></td><td><b>Student Roll Number</b></td><td><b>Student Email ID</b></td><td><b>Total Present <br> in this Semster</b></td><td><b>Total Absent <br> in this Semster</b></td><td><b>Overall Attendance<br> in Percentage</b></td></tr>
<?php
														 $i=0;
														 $sum=0;
														 $k=0;
													    ...
													    ?>
                                                          <tr style="text-align: center; margin-left:100px;"><td><?php echo $i; ?></td><td><?php echo $row22[5];?></td><td><?php echo $row22[6];?></td><td><?php echo $row22[7];?></td><td><?php echo $row3[0];?></td><td><?php echo $row4[0];?></td><td><?php echo $P;?> %</td></tr>
														<?php
                                                        }
														?>
</table>
