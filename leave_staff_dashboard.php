...
$s2= "select * from leave_student where (Semester='$sem' and Branch='$branch' and Section='$sec' and Faculty_Subject='$fs') ORDER BY Date DESC";
     $rs2=  $con->query($s2); 
...
<form action="leave_staff_dashboard_data.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row"style="text-align:center">
                        <div class="col d-flex flex-column flex-sm-row  mb-12" >
                            <div class="col-sm-6 col-md-9 col-lg-9 col-xl-9">
                                <h2 style=" color: brown;font-weight: bolder; font-size: 25px;"><i>Leave Verification</i></h2>
                            </div>
                        </div>
                      </div>
                    </div>
          ...
          <div class="col mb-3">
            <div class="card">
              <div class="card-body" style="background: seashell; border:3px solid black;">
					...
					<div class="col-3"></div>
	                                      <div class="col-6">
					                      <button name="leavestaff" type="submit" class="btn btn-primary btn-lg btn-block login-btn"><h2>Search</h2></button><br>
					                      </div>
                    </div>
                    </div>
                    </div>
                                                ...
                                                <div class="row">
                                                   <div class="col-md-12">
                                                        ...
                                                        <table class="table" border="2" style="font-size: 15px; text-align: center; background-color:lightcyan;">
                                                         <tr><td><b>S.No.</b></td><td><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Date&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></td><td><b>Student Name</b></td><td><b>Student Roll Number</b></td><td><b>Student Email ID</b></td><td><b>Leave Type</b></td><td><b>From Date</b></td><td><b>To Date</b></td><td><b>Lecture</b></td><td><b>Reason</b></td></tr>
                                                        <?php
														 $i=-1;
														while($row2= $rs2->fetch_array())
                                                        {
															...
															$row2[10] = date("d-M-Y", strtotime($row2[10]));
															$row2[11] = date("d-M-Y", strtotime($row2[11]));
													    ?>
                                                          <tr><td><?php echo $j; ?></td><td><?php echo $row2[9];?></td><td><?php echo $row2[2];?></td><td><?php echo $row2[5];?></td><td><?php echo $row2[3];?></td><td><?php echo $row2[12];?></td><td><?php echo $row2[10];?></td><td><?php echo $row2[11];?></td><td><?php echo $row2[13];?></td><td><?php echo $row2[14];?></td></tr>
                                                        <?php
                                                        }
														?>
</table>
