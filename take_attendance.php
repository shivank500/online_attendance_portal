...
<form action="take_attendance_data2.php" method="post" enctype="multipart/form-data">
            ...
            <div class="card-body" style="background: seashell; border:3px solid black;">
                  <div class="row"style="text-align:center">
                      <div class="col d-flex flex-column flex-sm-row justify-content-between mb-12" >
                          <h2 style=" color: orange; font-weight: bolder; text-align: center; font-size: 25px;"><i>Welcome to Take Attendance</i></h2>
                      </div>
					  <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4">
                                <h3><label style="color:blue;"><u>*Current Date and Time*	</u></label></h3>
								<?php 
								date_default_timezone_set("Asia/Calcutta");
                                $now=new DateTime();?>
                                <input type="hidden" value="<?php echo $now->format('Y-m-d && H:i:s'); ?>" name="datess" class="form-control" placeholder="Enter Date From" required="required">
								<h2 style="color:brown; font-weight:bolder;"><i><b><?php echo $now->format('d-M-Y'); ?><br>Time-><?php echo $now->format('h:i:s a'); ?><br>Day-><?php echo $now->format('D'); ?></b></i></h2>
                            </div>
							<div class="col-sm-3 col-md-3 col-lg-3 col-xl-3">
                                <h3><label style="color:red;"><u>*Select Lecture*	</u></label></h3>
	     <select class="form-control" name="lecture" required="required" style="font-size:15px;color:blue;">
    ...
    <div class="row flex-lg-nowrap">
      <div class="col" style="font-size: 5px;">
        <div class="row">
		  ...
		  <form action="take_attendance_data.php" method="post" enctype="multipart/form-data">
          <div class="container">
            <div class="row flex-lg-nowrap">
              <div class="col" style="font-size: 5px;">
                <div class="row">
                    ...
                    <div class="card">
                      <div class="card-body" style="background: seashell; border:3px solid black;">
                            <div class="row"style="text-align:center">
                                                ...
                                                <div class="row">
                                                   <div class="col-md-12">
                                                        ...
                                                        <table class="table" border="2" style="font-size: 15px; text-align: center; background-color:lightcyan;">
                                                         <tr><td><b>S.No.</b></td><td><b>Student Name</b></td><td><b>Student Roll Number</b></td><td><b>Student Email ID</b></td><td><b>Attendance</b></td></tr>
														<?php
														$i=-1;
														//date_default_timezone_set("Asia/Calcutta");
														while($row2 = $rs2->fetch_array())
                                                        {
															...
															$j=$i+1;
													    ?>
                                                          <tr><td><?php echo $j; ?></td><td><?php echo $row2[0] ?></td><td><?php echo $row2[2] ?></td><td><?php echo $row2[1] ?></td><td><input type="radio" name ="<?php echo 'attendance'.$i; ?>" value="present" required><label style="font-weight:bolder">Present&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label><input type="radio" name="<?php echo 'attendance'.$i; ?>" value="absent" required><label style="font-weight:bolder">Absent&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label> <input type="radio" name ="<?php echo 'attendance'.$i; ?>" value="leave" required><label style="font-weight:bolder">Leave&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label></td></tr>
							  ...
							  <button class="btn btn-primary btn-lg btn-block login-btn" style="font-size:23px; font-weight:bolder;background-color:lightgreen;" type="submit" name="take_attendance">Submit</button>
                            </div>
                            </div>
                          </div>
                        </div>
