...
<form action="views_student_staff_dashboard_data.php" method="post" enctype="multipart/form-data">
            ...
            <div class="card-body" style="background: seashell; border:3px solid black;">
                  <div class="row"style="text-align:center">
                      <div class="col d-flex flex-column flex-sm-row justify-content-between mb-12" >
                          <h2 style=" color: white; font-weight: bolder; text-align: center; color: brown; font-size: 25px;"><i>View's Student</i></h2>
                      </div>
                    </div>
                  </div>
                  </div>
          ...
          <div class="col mb-3">
            <div class="card">
              <div class="card-body" style="background: seashell; border:3px solid black;">
					...
					<div class="col-3"></div>
	                                      <div class="col-6">
					                      <button name="viesstus" type="submit" class="btn btn-primary btn-lg btn-block login-btn"><h2>Search</h2></button><br>
					                      </div>
                    </div>
					  <br><br>
                                                ...
                                                <div class="row">
                                                   <div class="col-md-12">
                                                        ...
                                                        <table class="table" border="2" style="font-size: 15px; text-align: center; background-color:lightcyan;">
                                                         <tr><td><b>S.No.</b></td><td><b>Student Name</b></td><td><b>Student Roll Number</b></td><td><b>Student Email ID</b></td><td><b>Student Contact Number</b></td></tr>
                                                        <?php
														 $i=1;
														while($row2= $rs2->fetch_array())
                                                        {
													    ?>
                                                          <tr><td><?php echo $i; ?></td><td><?php echo $row2[0];?></td><td><?php echo $row2[2];?></td><td><?php echo $row2[1];?></td><td><?php echo $row2[10];?></td></tr>
														<?php
														$i++;
                                                        }
														?>
                                                         ...
                                                         </div><a href="download_viewstudents_staff_dashboard.php"><h2>Click here to Download Student List</h2></a>
                                                   </div>
